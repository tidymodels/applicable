...
Education)](https://jse.amstat.org/v19n3/decock.pdf).
...
![Faceted empirical cumulative distribution chart for PCA-derived
metrics, with absolute metric values on the x-axis and percentile on the
y-axis.](continuous-data_files/figure-html/autoplot-1.png)

You can use regular expressions to plot a smaller subset of the pca
statistics:

![Two PCA distribution plots: one for components PC1 through PC5, and
one for distance values on a log-scaled x-axis, each showing percentile
on the y-axis.](continuous-data_files/figure-html/unnamed-chunk-5-1.png)

![Two PCA distribution plots: one for components PC1 through PC5, and
one for distance values on a log-scaled x-axis, each showing percentile
on the y-axis.](continuous-data_files/figure-html/unnamed-chunk-5-2.png)
...
![Histogram of first principal-component training scores with red
vertical lines marking the three new-sample PC01
values.](continuous-data_files/figure-html/unnamed-chunk-6-1.png)
...
#>                            0.3952457                            0.3136387 
#> MS_SubClass_Two_Story_1946_and_Newer                          Gr_Liv_Area 
#>                            0.3123708                            0.3040630 
#>                            Half_Bath 
#>                            0.2397437
```
...
![Histogram of gross living area in the training data with red vertical
lines showing the gross living area for the three new
properties.](continuous-data_files/figure-html/unnamed-chunk-8-1.png)
