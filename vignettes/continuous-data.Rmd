...
```{r}
#| echo: false
#| fig-alt: "Histogram chart. Gr_Liv_Area along the x-axis, count along the y-axis. Two red vertical lines are places. One on the edge of the distribution, another outside the distribution."
