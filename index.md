...
- [`vignette("binary-data", "applicable")`](https://applicable.tidymodels.org/articles/binary-data.md):
  Learn different methods to analyze binary data.

- [`vignette("continuous-data", "applicable")`](https://applicable.tidymodels.org/articles/continuous-data.md):
